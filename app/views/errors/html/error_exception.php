...
card.innerHTML=
    ...
    '<div class="nx-body">'+
        ...
        '<div class="nx-actions">'+
            '<button class="nx-btn-copy" onclick="copyErr(\''+uid+'\')"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg>Copiar</button>'+
...
function copyErr(id){
    var card=document.querySelector('[data-nx-err]');
    if(!card)return;
    var parts=card.dataset.nxErr.split('|');
    navigator.clipboard.writeText('Type: '+parts[0]+'\nMessage: '+parts[1]+'\nFile: '+parts[2]+'\nLine: '+parts[3]).catch(function(){});
}
})();
</script>
