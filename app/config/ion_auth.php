 ...
 */
$config['site_title']                 = "NEURIX POS";                      // Site Title, example.com This is not more functional
$config['admin_email']                = "arasoftsolutions@outlook.com";    // Admin Email, admin@example.com This is not more functional
...
$config['user_expire']                = 43200;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['forgot_password_expiration'] = 3600000;                   // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
