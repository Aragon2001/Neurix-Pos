    ...
    function index()
    {
        ...
        if ($this->form_validation->run() == true) {
            $data = array(
                ...
                'password_token_test' => $this->input->post('password_token_test'),
                'user_token_prod' => $this->input->post('user_token_prod'),
                'password_token_prod' => $this->input->post('password_token_prod'),
                'certificado_ced' => $this->input->post('certificado_ced'),
                'certificado_pin' => $this->input->post('certificado_pin'),
