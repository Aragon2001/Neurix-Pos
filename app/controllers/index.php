                ...
                ?>
                	<div class="row box_shape">
                        ...
                        <div class="col-md-6">
                            ...
                            $pre_id_number_opt = array('01' => translate('physical_card'), '02' => translate('legal_ID'), '03' => translate('dimex'), '04' =>  translate('nite'), '05' => translate('passport'));
                            ?>
                            <div class="form-group">
                                <select class="form-control " name="type_identification" placeholder="<?php echo translate('type_identification');?>" data-toggle="tooltip" title="<?php echo translate('type_identification');?>">
                                <?php
                                    echo "<option  value ='' selected><h2>".strtoupper(translate('type_identification'))."</option>";
                                    foreach ($pre_id_number_opt as $key => $val) {
                                        echo "<option  value =".$key."><br>".strtoupper($val)."</br></option>";
                                    }
                                ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control required" name="identification" type="text" placeholder="<?php echo translate('identification');?>" data-toggle="tooltip" title="<?php echo translate('identification');?>">
                            </div>
                        </div>
                        <div class="col-md-12" hidden="hidden">
                            <div class="form-group">
                                <select class="form-control " name="gender"  placeholder="<?php echo translate('gender');?>" data-toggle="tooltip" title="<?php echo translate('gender');?>">
                                    <option value=""><?php echo strtoupper(translate('gender'));?></option>
                                    <option value="male"><?php echo strtoupper(translate('male'));?></option>
                                    <option value="female"><?php echo strtoupper(translate('female'));?></option>
                                    <option value="other"><?php echo strtoupper(translate('does_not_specify'));?></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input class="form-control" name="phone" type="tel" placeholder="<?php echo translate('phone');?>" data-toggle="tooltip" title="<?php echo translate('phone');?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-6" hidden="hidden">
                            <div class="form-group">
                                <input class="form-control " name="zip" type="text" placeholder="<?php echo translate('zip');?>" data-toggle="tooltip" title="<?php echo translate('zip');?>">
                            </div>
                        </div>
