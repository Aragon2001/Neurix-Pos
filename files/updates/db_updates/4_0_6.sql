...
INSERT INTO `tec_stores` (`name`, `code`, `logo`, `email`, `phone`, `address1`, `address2`, `city`, `state`, `postal_code`, `country`, `currency_code`, `receipt_footer`) VALUES ('SimplePOS', 'POS', 'logo.png', 'store@gi3-softsolutions.com', '012345678', 'Address Line 1', '', 'Petaling Jaya', 'Selangor', '46000', 'Malaysia', 'MYR', 'This is receipt footer for store');
...
(1, 'Test Supplier', '1', '2', '0123456789', 'supplier@gi3-softsolutions.com');
