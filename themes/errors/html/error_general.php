...
.particles span{position:absolute;border-radius:50%;background:#f59e0b;animation:drift linear infinite;}
@keyframes drift{
...
.btn-s{background:transparent;color:#94a3b8;border:1px solid rgba(245,158,11,.15);}
