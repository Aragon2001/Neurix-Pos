                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {
                                        $select='';
                                        if($product->id_tax==$impuesto->id_impuesto)
                                            $select='selected';

                                        $optiones.='<option value="'.$impuesto->id_impuesto.'" '.$select.'>'.$impuesto->descripcion_impuesto.'</option>';
                                ...
                                <script>
                                    function refresca() {
                                        precio_sin_imp = $('#price').val();
                                        precio_con_imp = $('#price_conimp').val();
                                        tax = $('#product_tax').val();
										taxrate = $('#pit'+tax).val();
										
                                        invert_imp = (parseFloat(taxrate) / 100) + 1;
                                        $('#price').removeAttr("readonly")
                                        $('#price').val(precio_con_imp / invert_imp);
                                        $('#price').attr("readonly", "readonly")
                                    }

                                    $(function () {
                                        $('#price_conimp').on('keyup', function () {
                                            refresca();
                                        });
                                ...
                                <div class="st">
                                    ...
                                    <table class="table">
                                        ...
                                        <?php foreach($ubicaciones as $ub){
                                           echo  "<tr><td><input type='checkbox' class='record'></td>
                                            <td><input name='seccion[]' class='form-control'  value='{$ub->seccion}' /></td>
                                            <td><input name='tramo[]' class='form-control'  value='{$ub->tramo}' /></td>
                                            </tr>";
                                        }?>
										<?php }?>
                                        </tbody>
...
<?php if ($product->present_fraccion == 1) { ?>
            $("#present_fraccion").prop("checked", true);
<?php } ?>

<?php if ($product->present_caja == 1) { ?>
            $("#present_caja").prop("checked", true);
<?php } ?>
