            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="code"><?= $this->lang->line("code"); ?></label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="receipt_footer"><?= $this->lang->line("receipt_footer"); ?></label>
