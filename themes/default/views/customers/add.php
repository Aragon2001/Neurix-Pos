					...
					<div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="cf1" class="form-control tom-select" id="cf1" style="width:100%;">
                                <option <?= (isset($customer->cf1) && $customer->cf1 == '01') ? 'selected="selected"' : ''; ?> value="01">01 — Cédula Física</option>
                                <option <?= (isset($customer->cf1) && $customer->cf1 == '02') ? 'selected="selected"' : ''; ?> value="02">02 — Cédula Jurídica</option>
                                ...
                                <option <?= (isset($customer->cf1) && $customer->cf1 == '05') ? 'selected="selected"' : ''; ?> value="05">05 — Pasaporte</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <?= form_input('cf2', set_value('cf2'), 'class="form-control" id="cf2" placeholder="Ej: 112340567"');?>
                        ...
                        <div class="mb-3">
                            ...
                            <?= form_input('codigo_actividad', set_value('codigo_actividad'), 'class="form-control" id="codigo_actividad" maxlength="6" placeholder="Ej: 811001"');?>
