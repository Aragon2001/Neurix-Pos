					...
					<div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="cf1" class="form-control tom-select" id="cf1" style="width:100%;">
                                ...
                                <option <?= (isset($customer->cf1) && $customer->cf1 == '04') ? 'selected="selected"' : ''; ?> value="04">NITE</option>
                                <option <?= (isset($customer->cf1) && $customer->cf1 == '05') ? 'selected="selected"' : ''; ?> value="05">Pasaporte</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <?= form_input('cf2', set_value('cf2'), 'class="form-control" id="cf2"');?>
