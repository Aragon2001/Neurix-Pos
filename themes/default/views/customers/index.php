...
<div class="nxt-head">
    ...
    <div class="nxt-head-actions">
        ...
        <a class="nxt-btn" href="<?= site_url('customers/add'); ?>">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var t = new NxTable({
        ...
        exportName: 'clientes',
        search: ['name', 'phone', 'email', 'cf2'],
        chips: { key: 'cf1', all: '<?= lang('todas'); ?>', label: function (v) { return ID_TYPES[v] || v; } },
        columns: [
            ...
            { key: 'limitcredit', label: '<?= lang('limitcredit'); ?>', className: 'num', sortable: 'num', render: function (r) {
                var v = parseFloat(r.limitcredit) || 0;
                return v > 0 ? '<span class="nxt-price">' + NxTable.money(v) + '</span>' : '<span class="nxt-dim-mono">—</span>';
            } },
