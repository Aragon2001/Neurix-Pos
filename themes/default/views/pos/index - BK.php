...
<html>
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <?php if ($this->db->dbdriver != 'sqlite3') { ?>
                                <li><a href="<?= site_url('pos/view_bill'); ?>" target="_blank"><i
                                            class="fa fa-desktop"></i></a></li>
                                <?php } ?>


                            <li><a href=""
                                   data-toggle="ajax" id="btnCloseregister"><?= lang('close_register'); ?></a></li>


                            <li><a href=""
                                   data-toggle="ajax" id="btnCreditNote">Notas de Credito</a></li>
                            ...
                            <?php if ($suspended_sales) { ?> 
                                <li class="dropdown notifications-menu" id="suspended_sales">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="footer"><a
                                                href="<?= site_url('sales/opened'); ?>"><?= lang('view_all'); ?></a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                        ...
                        <?php if ($Admin) { ?>
                            <li class="treeview mm_products">
                                ...
                                <ul class="treeview-menu">
                                    <li id="products_index"><a href="<?= site_url('products'); ?>"><i
                            ...
                            <?php if ($this->session->userdata('store_id')) { ?>
                                <li class="treeview mm_sales">
                                    ...
                                    <ul class="treeview-menu">
                                        <li id="sales_index"><a href="<?= site_url('sales'); ?>"><i
                                                    class="fa fa-circle-o"></i> <?= lang('list_sales'); ?></a></li>
                                        ...
                                        <?php if ($Settings->enable_layaway) { ?>                                                    
                                            <li id="sales_apartado"><a href="<?= site_url('sales/apartado'); ?>"><i class="fa fa-circle-o"></i> <?= lang('list_apartado_sales'); ?></a></li>
                                        <?php } ?>

                                        <?php if ($Settings->enable_quote) { ?>                                                    
                                            <li id="sales_proforma"><a href="<?= site_url('sales/proforma'); ?>"><i class="fa fa-circle-o"></i> <?= lang('list_quotes_sales'); ?></a></li>
                                        <?php } ?>                                              
                                    </ul>
                                </li>
                            ...
                            <li class="treeview mm_auth mm_customers mm_suppliers">
                                ...
                                <ul class="treeview-menu">
                                    <li id="auth_users"><a href="<?= site_url('users'); ?>"><i
                                                class="fa fa-circle-o"></i> <?= lang('list_users'); ?></a></li>
                                    <li id="auth_add"><a href="<?= site_url('users/add'); ?>"><i
                                                class="fa fa-circle-o"></i> <?= lang('add_user'); ?></a></li>
                                    <li class="divider"></li>
                            ...
                            <li class="treeview mm_settings">
                                ...
                                <ul class="treeview-menu">
                                    <li id="settings_index"><a href="<?= site_url('settings'); ?>"><i
                                                class="fa fa-circle-o"></i> <?= lang('settings'); ?></a></li>
                                    <li class="divider"></li>
    ...
    <!-- <li id="settings_updates"><a href="<?= site_url('settings/updates'); ?>"><i class="fa fa-circle-o"></i> <?= lang('updates'); ?></a></li> -->
                            ...
                            <li class="treeview mm_reports">
                                ...
                                <ul class="treeview-menu">
                                    <li id="reports_credit_customers"><a href="<?= site_url('reports/credit_customers'); ?>"><i
                                                class="fa fa-circle-o"></i> Estado de cuenta clientes</a></li>
                                ...
                                <div class="well well-sm" id="leftdiv">
                                    <div id="lefttop" style="margin-bottom:5px;">
                                        <div class="form-group" style="margin-bottom:5px;">
                                            ...
                                            <button type="button" class="btn btn-warning  btn-block btn-flat external add_tips" id="add_tips">Aplicar Servicio (<?php echo $Settings->propina_rate ?>%)</button>
                                            <?php } ?>
                                            <button type="button" class="btn btn-success  btn-block btn-flat external boton_nuevo_cliente" id="add-customer" 
                                                    data-toggle="modal"
                                                    data-target="#myModal">Nuevo Cliente</button>
                                            <button type="button"class="btn btn-info btn-block btn-flat boton_agregar_notas" data-toggle="modal"
                                                    data-target="#ModalNotes">Agregar Notas</button>
                                            <!--                                                <button type="button" style="width: 15%; height: 34px; float: left; margin-top: 5px;" class="btn btn-warning  btn-block btn-flat" data-toggle="modal"
                                                                                                   data-target="#ModalNotes">Agregar Exoneracion</button>-->
                                        ...
                                        <?php if ($t_nc) { ?>
                                            <div class="form-group" style="margin-bottom:5px;">
                                                <input type="text" name="hold_ref"
                                                       required="required"
                                                       value="" id="hold_ref"
                                                       class="form-control kb-text"
                                                           placeholder="<?= lang("reason_credit_note") ?>"
                                                           />
                                            </div>
                                        <?php } ?>
                                        ...
                                        <?php if (!$t_nc && !$apa) { ?>
                                            <div class="form-group" style="margin-bottom:5px; overflow: hidden;">
                                                ...
                                                <input type="text" style="float: left; width: 85%;" name="code" id="add_item"
                                                       class="form-control"
...
<!--                                                        <td width="25%"><a href="#" id="add_tax"><?= lang('order_tax') ?></a></td>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-4" style="padding: 0;">
                                                    ...
                                                    <div class="btn-group-vertical btn-block">
                                                        <?php if (!$t_nc && !$apa) { ?>
                                                            <button type="button" class="btn btn-warning btn-block btn-flat"
                                                                    id="suspend" style="width: 50%; float: left;"><?= lang('hold'); ?></button>
                                                                <?php } ?>

                                                        <?php if (!$t_nc && !$apa) { ?>
                                                            <button type="button" style="width: 50%; float: left; height: 50px; margin-top: 0px;" class="btn bg-purple btn-block btn-flat" id="quotes">Proforma</button>
                                                        <?php } ?>

                                                        <?php if (!$apa) { ?>
                                                            <button type="button" class="btn btn-danger btn-block btn-flat"
                                                                    id="reset" style="width: 50%; float: left; <?php if ($t_nc) { ?> height: 67px;<?php } ?>"><?= lang('cancel'); ?></button>
                                                                <?php } else { ?>
                                                            <button type="button" class="btn btn-danger btn-block btn-flat"
                                                                    id="reset" style="width: 100%; float: left; height: 97px;"><?= lang('cancel'); ?></button>
                                                                <?php } ?>

                                                        <?php if (!$t_nc && !$apa) { ?>
                                                            <button type="button" style="width: 50%; float: left; height: 48px;" class="btn bg-navy btn-block btn-flat" id="Apartado">Apartado</button>
                                                        <?php } ?>
                                                ...
                                                <?php } elseif ($Settings->enable_layaway === "1" && $Settings->enable_quote === "0") { ?>
                                                    <div class="btn-group-vertical btn-block">
                                                        <?php if (!$apa) { ?>
                                                            <button type="button" class="btn btn-danger btn-block btn-flat"
                                                                    id="reset" style="    margin-top: -1px; height: 47px; width: 50%; float: left; <?php if ($t_nc) { ?> height: 67px;<?php } ?>"><?= lang('cancel'); ?></button>
                                                                <?php } else { ?>
                                                            <button type="button" class="btn btn-danger btn-block btn-flat"
                                                                    id="reset" style="    margin-top: -1px; height: 47px; width: 100%; float: left; height: 97px;"><?= lang('cancel'); ?></button>
                                                                <?php } ?>
                                                                <?php if (!$t_nc && !$apa) { ?>
                                                            <button type="button" class="btn btn-warning btn-block btn-flat"
                                                                    id="suspend" style="height: 47px; width: 50%; float: left;"><?= lang('hold'); ?></button>
                                                                <?php } ?>
                                                                <?php if (!$t_nc && !$apa) { ?>
                                                            <button type="button" style="width: 100%; float: left; height: 52px;" class="btn bg-navy btn-block btn-flat" id="Apartado">Apartado</button>
                                                        <?php } ?>
                                                ...
                                                <?php } elseif ($Settings->enable_layaway === "0" && $Settings->enable_quote === "1") { ?>
                                                    <div class="btn-group-vertical btn-block">
                                                        ...
                                                        <?php if (!$t_nc && !$apa) { ?>
                                                            <button type="button" style="width: 100%; float: left; height: 52px; margin-top: 0px;" class="btn bg-purple btn-block btn-flat" id="quotes">Proforma</button>
                                                        <?php } ?>
                                                ...
                                                <div class="col-xs-4" style="padding: 0 5px;">
                                                    <div class="btn-group-vertical btn-block">
                                                        <button type="button" class="btn bg-purple btn-block btn-flat"
                                                                id="print_order"><?= lang('print_order'); ?></button>

                                                        <button type="button" class="btn bg-navy btn-block btn-flat"
                                                                id="print_bill"><?= lang('print_bill'); ?></button>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            <div
                                            <?php if (!$t_nc) { ?>
                                                ...
                                                <?php } else { ?>
                                                    <button type="button" class="btn btn-success btn-block btn-flat"
                                                            id="submit-sale"
                                                            style="height:97px;">Realizar Factura de Apartado
                                                    </button>
                                                <?php } ?>                                        
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?php if (!$t_nc) { ?>
                                                    <input style="width: 49%; float:left; margin-right: 2%;" type="text" name="hold_ref"
                                                           value="<?= $reference_note; ?>" id="hold_ref"
                                                           class="form-control kb-text"
                                                           placeholder="<?= lang('reference_note') ?>"
                                                           />
                                                       <?php } ?>
                                                <input style="width: 49%; float:left;"type="text" name="spos_note"
                                                       id="spos_note"
                                                       class="form-control kb-text"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <h4>Otros Textos <small>(Agregue otros textos en esta seccion estos apareceran en el xml del tiquete electronico)</small></h4>
                                                    <button type="button" style="width: 100%; height: 34px; float: left; margin-top: 5px;" class="btn btn-info btn-block btn-flat agregatexto" >Agregar otro texto</button>
                                                    <table style="width: 100%">
                                                        <thead>
                                                            <tr style="background: #a3d2da;  font-size: 16px;  font-weight: bold;">
                                                                <td style="width: 25%; text-align: center;">Asunto / Codigo</td>
                                                                <td style="width: 73%; border-left: 1px solid #9c9c9c; text-align: center;">Texto</td>
                                                                <td style="width: 2%; border-left: 1px solid #9c9c9c; text-align: center;"><i class="fa fa-trash-o" style="padding: 0 5px; font-size: 18px;"></i></td>
                                                            </tr>
                                                        </thead>
                                                            ...
                                                            <?php if (isset($otrostextos) and $otrostextos) { ?>
                                                                ...
                                                                <?php foreach ($otrostextos as $texto) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><span style="padding: 0 5px;"><i class="fa fa-trash-o eliminatexto" style="font-size: 18px; cursor:pointer;"></i></span></td>
                                                                    </tr>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        </tbody>
                            ...
                            <div class="contents" id="right-col">
                                ...
                                <div class="product-nav">
                                    <div class="btn-group btn-group-justified">
                                        <div class="btn-group">
                                            <button style="z-index:10002;" class="btn btn-warning pos-tip btn-flat"
                                                    type="button" id="previous"><i class="fa fa-chevron-left"></i></button>
                                        </div>
                                        <div class="btn-group">
                                            <button style="z-index:10003;" class="btn btn-success pos-tip btn-flat"
                                                    type="button" id="sellGiftCard"><i class="fa fa-credit-card"
                                                                               id="addIcon"></i> <?= lang('sell_gift_card') ?>
                                            </button>
                                        </div>
                                        <div class="btn-group">
                                            <button style="z-index:10004;" class="btn btn-warning pos-tip btn-flat"
                                                    type="button" id="next"><i class="fa fa-chevron-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;"><a href="#" class="fa fa-cogs"></i></a></div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm kb-pad" id="nPrice"
                                           onClick="this.select();"
                                           placeholder="<?= lang('new_price') ?>">
                                </div>
                                <div class="form-group">
                                    <?= lang('discount', 'nDiscount') ?>
                                    <input type="text" class="form-control input-sm kb-pad" readonly="readonly" id="nDiscount"
                                           onClick="this.select();" placeholder="<?= lang('discount') ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <?= lang('quantity', 'nQuantity') ?>
                                    <input type="text" class="form-control input-sm kb-pad" id="nQuantity"
                                           onClick="this.select();" placeholder="<?= lang('current_quantity') ?>">
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal" data-easein="flipYIn" id="ProforModal" tabindex="-1" role="dialog" aria-labelledby="ProforModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal" data-easein="flipYIn" id="ApartadoModal" tabindex="-1" role="dialog" aria-labelledby="ApartadoModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal" data-easein="flipYIn" id="cpModal" tabindex="-1" role="dialog" aria-labelledby="cpModalLabel"
             aria-hidden="true"></div>
                            ...
                            <div class="col-xs-12">
                                <div class="font16">
                                    <table class="table table-bordered table-condensed"
                                           style="width:100%; margin-bottom: 0; font-size:40px;">
                                        <tbody>
                                            <tr>
                                                <td width="25%"
                                                    style="border-right-color: #FFF !important;"><?= lang("total_payable"); ?></td>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="pcc" style="display:none;">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" id="pcc_no"
                                                       class="form-control kb-pad"
                                                       placeholder="<?= lang('cc_no') ?>"/>


                                                <input type="hidden" id="pcc_holder"
                                                       class="form-control kb-text"
                                                ...
                                                <input type="hidden" id="pcc_month"
                                                       class="form-control kb-pad"
                                                       placeholder="<?= lang('month') ?>"/>

                                                <input type="hidden" id="pcc_year"
                                                       class="form-control kb-pad"
                                                       placeholder="<?= lang('year') ?>"/>


                                                <input type="hidden" id="pcc_cvv2"
                                                       class="form-control kb-pad"
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <select name="cf1" class="form-control input-sm selct2" id="cf1"  required="required">
                                        <option <?php @$customer->cf1 == '01' ? ' selected selected="selected"' : '' ?>
                                            value="01">Cedula de Identidad
                                        </option>
                                        <option <?php @$customer->cf1 == '02' ? ' selected selected="selected"' : '' ?>
                                            value="02">Cedula Juridica
                                        </option>
                                        <option <?php @$customer->cf1 == '03' ? ' selected selected="selected"' : '' ?>
                                            value="03">DIMEX
                                        </option>
...
<?php unset($Settings->protocol, $Settings->smtp_host, $Settings->smtp_user, $Settings->smtp_pass, $Settings->smtp_port, $Settings->smtp_crypto, $Settings->mailpath, $Settings->timezone, $Settings->setting_id, $Settings->default_email, $Settings->version, $Settings->stripe, $Settings->stripe_secret_key, $Settings->stripe_publishable_key); ?>
            ...
            var quo = false, username = '<?= $this->session->userdata('username'); ?>', spositems = {};
            var apa = false, username = '<?= $this->session->userdata('username'); ?>', spositems = {};
            ...
            var gtotal = 0, order_discount = 0, order_tax = 0, protect_delete = <?= ($Admin) ? 0 : ($Settings->pin_code ? 1 : 0); ?>, protect_closeregister = 1, protect_changeprice = 1, protect_opendrawer = 1, protect_creditnote = 1, type_printer = "<?= $printer_default->type ?>";
...
<?php } ?>
            ...
            $('#quotes').click(function () {
                if (count <= 1) {
                    ...
                    $('#ProforModal').modal({backdrop: 'static'});
            ...
            $('#Apartado').click(function () {
                if (count <= 1) {
                    ...
                    $('#ApartadoModal').modal({backdrop: 'static'});
