                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td class="col-2"><?= lang('date'); ?></td>
                                    <td class="col-10"><?= $this->tec->hrld($purchase->date); ?></td>
                                </tr>
                                <tr>
                                ...
                                if ($purchase->attachment) {
                                    ?>
                                    <tr>
                                        <td class="col-2"><?= lang('attachment'); ?></td>
                                        <td class="col-10"><a href="<?=base_url('uploads/'.$purchase->attachment);?>"><?= $purchase->attachment; ?></a></td>
                                    </tr>
                                    <?php
                                }
                                if ($purchase->note) {
                            ...
                            <table class="table table-striped table-bordered" style="margin-bottom:0;">
                                ...
                                <thead>
                                    <tr class="active">
                                        ...
                                        <td class="col-2"></td>
                                        <td class="col-2"></td>
                                        <td class="col-2 text-right"><?=$this->tec->formatMoney($purchase->total);?></td>
                                    </tr>
                                </thead>
                            </table>
                        </div>
