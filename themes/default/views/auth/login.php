    ...
    <body class="login-page login-page-<?= $Settings->theme_style; ?> rtl rtl-inv">
        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="<?= base_url(); ?>"><?= $Settings->theme_style == 'purple' ? '<img src="' . $assets . 'dist/css/base/logo1.png" alt="' . $Settings->site_name . '" />' : '<img src="' . base_url('uploads/' . $Settings->logo) . '" alt="' . $Settings->site_name . '" />'; ?></a>
            </div>
            ...
            <div class="login-box-body">
                ...
                <div class="form-group has-feedback">
                    <select name="printer_default" class="form-control" placeholder="<?= lang('email'); ?>">
                        <? foreach($impresoras as $print){ ?>
                        <option value="<?= $print->id ?>"><?= $print->title ?></option>
                        <? } ?>
                    </select>
                </div>
                <div class="form-group has-feedback">
                    <input type="text" name="identity" value="<?= set_value('identity', (DEMO ? 'admin@gi3-softsolutions.com' : '')); ?>" class="form-control" placeholder="<?= lang('email'); ?>" />
