...
<head>
    ...
    <title><?= lang('promo_page_title'); ?></title>
    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner cover">
                <h1 class="cover-heading"><?= lang('promo_gracias_visita'); ?></h1>
                <p class="lead"><?= lang('promo_vuelva'); ?></p>
                <p class="lead"><?= lang('promo_recomendacion'); ?></p>
