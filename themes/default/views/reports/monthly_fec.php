...
document.addEventListener('DOMContentLoaded', function () {
    /* Columnas de dinero: [clave, etiqueta] */
    var MONEY = [
    ...
    var cols = [
        ...
        { key: 'creditoCompra', label: '<?= lang('credito_compras'); ?>', render: function (r) { return '<span class="nxt-dim-mono">' + NxTable.esc(r.creditoCompra == null ? '—' : r.creditoCompra) + '</span>'; } },
