...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var table = new Tabulator('#SLRData', {
            ...
            'ajax' : { url: '<?=site_url('reports/get_monthly_sales/'. $v);?>', type: 'POST', "data": function ( d ) {
...
<script type="text/javascript">
    $(function () {
        ...
        $('.datepicker').tempusDominus = new TempusDominus({format: 'YYYY-MM', showClear: true, showClose: true, useCurrent: false, widgetPositioning: {horizontal: 'auto', vertical: 'bottom'}, widgetParent: $('.dataTable tfoot')});
    });
</script>
