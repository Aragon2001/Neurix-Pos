...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = new Tabulator('#PrRData', {
            ...
            { "data": "code" },
            { "data": "name" },
            { "data": "quantity", "searchable": false, "render": quantityFormat },
            { "data": "cost", "searchable": false, "render": currencyFormat },
            ],
            "footerCallback": function (  tfoot, data, start, end, display ) {
                var api = this.api(), data;
                $(api.column(3).footer()).html( (api.column(3).data().reduce( function (a, b) { return parseFloat(pf(a) + pf(b)).toFixed(2); }, 0)) );
                $(api.column(4).footer()).html( (api.column(4).data().reduce( function (a, b) { return parseFloat(pf(a) + pf(b)).toFixed(2); }, 0)) );
            }
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        echo form_dropdown('product', $pr, set_value('product'), 'class="form-control tom-select" style="width:100%" id="product"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-4">
