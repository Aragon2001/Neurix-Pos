...
<div class="modal-dialog modal-lg no-modal-header">
    <div class="modal-content">
        <div class="modal-body print">
            ...
            <div class="clearfix"></div>
            <?php
            $rep_apto = isset($hacienda) && $hacienda
                && $hacienda->estatus_hacienda === 'aceptado'
                ...
                <div class="col-sm-12 text-right">
                    <?php if ($rep_exists): ?>
                        <span class="label label-success" style="font-size:13px;padding:6px 12px;">
                            <i class="fa fa-check"></i> REP generado
                        </span>
                    <?php else: ?>
                        <a href="<?= site_url('Shacienda/generarREP/' . $payment->id); ?>"
                           class="btn btn-warning"
                           onclick="return confirm('¿Generar Recibo Electrónico de Pago (REP) para este pago?');">
                            <i class="fa fa-file-text-o"></i> Generar REP (Hacienda)
                        </a>
                    <?php endif; ?>
                </div>
            </div>
