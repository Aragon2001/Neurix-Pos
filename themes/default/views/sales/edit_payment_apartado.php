...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?= form_open_multipart("sales/edit_payment_apartado/" . $payment->id ."/".$payment->apartado_id); ?>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <input type="hidden" value="<?php echo $payment->apartado_id; ?>" name="apartado_id"/>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_payment_apartado', lang('edit_payment'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
