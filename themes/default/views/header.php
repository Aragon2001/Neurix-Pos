...
<html>
    ...
    <body class="skin-<?= $Settings->theme_style; ?> fixed sidebar-mini">
        <div class="wrapper rtl rtl-inv">
                        ...
                        <?php if ($Admin) { ?>
                            <li class="treeview mm_products">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <?php if ($this->Settings->enable_fastedition == "1") { ?>
                                        <li id="products_fastedit"><a href="<?= site_url('products/fastedit'); ?>"><i class="fa fa-circle-o"></i> Edicion Rapida</a></li>
                                <?php } ?>
                                    <li id="products_ajuste"><a href="<?= site_url('products/ajuste'); ?>"><i class="fa fa-circle-o"></i> Ajuste de Invenatrio</a></li>
                                    ...
                                    <li class="divider"></li>
                                    <li id="products_prices"><a href="<?= site_url('products/listprices'); ?>"><i class="fa fa-circle-o"></i>Lista de precios</a></li>
                                    <li id="products_import"><a href="<?= site_url('products/addprices'); ?>"><i class="fa fa-circle-o"></i>Agregar Precios</a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                            ...
                            <?php if ($this->session->userdata('store_id')) { ?>
                                ...
                                <li class="treeview mm_purchases">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <? if($Settings->fe == "1"){ ?>
                                        <li class="divider"></li>
                                        <li id="document_upload"><a href="<?= site_url('cargadocumentos'); ?>"><i class="fa fa-circle-o"></i> <?= lang('documents_upload'); ?></a></li>
                                        <li class="divider"></li>
                                        <? } ?>
                                        ...
                                        <li class="divider"></li>
                                        <li id="purchases_fec"><a href="<?= site_url('facturascompras/'); ?>"><i class="fa fa-circle-o"></i> <?= lang('list_fec'); ?></a></li>
                                        <li id="purchases_add_fec"><a href="<?= site_url('facturascompras/create_fec'); ?>"><i class="fa fa-circle-o"></i> <?= lang('add_fec'); ?></a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                            ...
                            <li class="treeview mm_settings">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li id="settings_actividad">
                                        <a href="<?= site_url('settings/actividad'); ?>"><i class="fa fa-circle-o"></i> <span><?= lang('actividad'); ?></span></a>
                                    </li>

                                    <li id="settings_actividad_add">
                                        <a href="<?= site_url('settings/add_actividad'); ?>"><i class="fa fa-circle-o"></i> <span><?= lang('add_actividad'); ?></span></a>
                                    </li>
                                    <?php if($Settings->is_shipping == 1){?>
                                    <li class="divider"></li> 
                                    <li id="settings_shipping">
                                        <a href="<?= site_url('settings/shipping'); ?>"><i class="fa fa-circle-o"></i> <span><?= lang('shipping_method'); ?></span></a>
                                    </li>

                                    <li id="settings_shipping_add">
                                        <a href="<?= site_url('settings/add_shipping'); ?>"><i class="fa fa-circle-o"></i> <span><?= lang('add_shipping'); ?></span></a>
                                    </li>
                                    <?php }?>
                                    <?php if($Settings->propina_enable == '1'){ ?>
                                    <li class="divider"></li> 
                                    <li id="waiting_tables">
                                        <a href="<?= site_url('settings/waiting_tables'); ?>"><i class="fa fa-circle-o"></i> <span>Lista de mesas</span></a>
                                    </li>

                                    <li id="settings_shipping_add">
                                        <a href="<?= site_url('settings/add_table'); ?>"><i class="fa fa-circle-o"></i> <span>Agregar mesas</span></a>
                                    </li>
                                    <?php }?>
                                    <li class="divider"></li>
                                ...
                                <?php } ?>
                                    ...
                                    <?php if ($this->db->dbdriver != 'sqlite3') { ?>
                                        ...
                                        <li><a href="<?= site_url('settings/getDownloadxml'); ?>"><i class="fa fa-hdd-o"></i> Backup XMLs</a></li>
                                <?php } ?>
                            ...
                            <li class="treeview mm_reports">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <?php if($Settings->is_shipping == 1){?>
                                    <li id="reports_credit_shipping"><a href="<?= site_url('reports/credit_shipping'); ?>"><i class="fa fa-circle-o"></i> Estado de cuenta envios</a></li>
                                    <?php }?>
                                    ...
                                    <li id="reports_monthly_fec"><a href="<?= site_url('reports/monthly_fec'); ?>"><i class="fa fa-circle-o"></i> 
                                    <?= lang('monthly_fec');  ?>
                                    </a></li>
                                    <li id="reports_monthly_sale_tax"><a href="<?= site_url('reports/monthly_sale_tax'); ?>"><i class="fa fa-circle-o"></i> <?= lang('monthly_sale_tax'); ?></a></li>
                                    <!--<li id="reports_index"><a href="<?= site_url('reports'); ?>"><i class="fa fa-circle-o"></i> <?= lang('sales_report'); ?></a></li>-->
                                    <li class="divider"></li>
                                    <li id="sale_fe"><a href="<?= site_url('reports/sale_fe'); ?>"><i class="fa fa-circle-o"></i> <?= lang('model_d104'); ?></a></li>
                                    <li id="d151"><a href="<?= site_url('reports/d151'); ?>"><i class="fa fa-circle-o"></i> <?= lang('model_d151'); ?></a></li>
                                    <!--<li id="reports_index"><a href="<?= site_url('reports'); ?>"><i class="fa fa-circle-o"></i> <?= lang('sales_report'); ?></a></li>-->
                                    <li class="divider"></li>
                                    ...
                                    <li id="reports_products"><a href="<?= site_url('reports/products_quantity'); ?>"><i class="fa fa-circle-o"></i> <?= lang('products_quantity'); ?></a></li>
                                    <li id="inventory_adjustment"><a href="<?= site_url('reports/inventory_adjustment'); ?>"><i class="fa fa-circle-o"></i> <?= lang('inventory_adjustment'); ?></a></li>
                                </ul>
                            </li>
                            <?php } else { ?>
            ...
            <div class="content-wrapper <?= "panel_".$Settings->theme_style ?>">
