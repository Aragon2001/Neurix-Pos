...
<script type="text/javascript">
    $(function () {
        ...
        $('.datepicker').datetimepicker({format: 'YYYY-MM', showClear: true, showClose: true, useCurrent: false, widgetPositioning: {horizontal: 'auto', vertical: 'bottom'}, widgetParent: $('.dataTable tfoot')});
    });
</script>
