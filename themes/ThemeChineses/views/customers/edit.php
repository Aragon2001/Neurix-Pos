      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
              ...
              <?= form_input('business_name', set_value('business_name', $customer->business_name), 'class="form-control input-sm" id="business_name"'); ?>
          </div>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <?= form_input('codigo_actividad', set_value('codigo_actividad', @$customer->codigo_actividad), 'class="form-control input-sm" id="codigo_actividad" maxlength="6" placeholder="Ej: 811001"');?>
